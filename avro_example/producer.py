...
class RideAvroProducer:
    def __init__(self, props: Dict):
        ...
        # Schema registry client begins from the same confluent.kafka.schema_registry.
        schema_registry_client = SchemaRegistryClient(schema_registry_props)
        #This can also be something like an integer serializer.,
        #but here Avro being the data file that we are using we use avro.
        # Here conversion to object is being done.
        # We don't need to worry about the serializer converting our data into binary it just does it for us.
    ...
    #While publishing hoping it to be in a RideRecordKey structure.
...
#The major benefit of this way than in json_examples is that this way we don't have to worry
#about the expected format that kafka/docker expects using serializer. 
# Its more like what we should pass, what kind of information we should pass and so on.